...
class PasswordGenerator(tk.Tk):
    def __init__(self):
        ...
        self.password_generator = tk.Label(self, text="Password Generator", font=("Arial", 20, "bold"), fg="RED")
        ...
        self.generate_button = tk.Button(self, text="Generate", command=self.generate_password, font=("Calibri", 10, "bold"),bg="RED", fg="white")
